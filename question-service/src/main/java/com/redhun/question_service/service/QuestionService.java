...
import com.redhun.question_service.dao.QuestionDao;
...
public class QuestionService {
    ...
    public ResponseEntity<List<Integer>> getQestionsForQuiz(String categoryName, Integer numQuestions) {

        List<Integer> qustions = questionDao.findRandomQuestionsByCatogory(categoryName, numQuestions);
